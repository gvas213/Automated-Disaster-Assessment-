...
export default function Map({ currentIndex, onTotalChange, showPolygon, showHurricanePath, polygonMinZoom, onZoomChange, onFeatureSelect, onAssessClick, }) {
  ...
  title="Upload images for damage assessment"
  className="border border-zinc-600 bg-black/30 backdrop-blur-md text-white text-sm px-4 py-2 rounded-full hover:bg-white hover:text-black hover:border-transparent transition-all duration-300 flex items-center gap-2"
>
  <svg
